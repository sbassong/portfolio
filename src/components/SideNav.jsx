      ...
      <div className="px-12">  
        <a href="#introduction">
          ...
          <div className="text-white lg:max-w-lg lg:w-5/6 w-5/6 mt-7 mb-10 mx-auto">
            ...
            <p className="text-lg title-font mt-1 font-medium text-yellow-400">Full-Stack Software Engineer</p>
          </div>
        </a>
        ...
        <div class="text-white lg:max-w-lg lg:w-full w-5/6">
          ...
          <a href="https://www.linkedin.com/in/sambassong/" className="w-3/5 my-4 inline-flex items-center bg-blue-500 border-0 py-2 px-5 focus:outline-none hover:bg-blue-600 rounded text-white mt-4 md:mt-0" rel="noreferrer" target="_blank"><FaLinkedin className="w-5 h-5 mr-1" />Let's connect!</a>
          <a href="https://github.com/sbassong" className="w-3/5 my-4 inline-flex items-center bg-gray-800 border-0 py-2 px-8 focus:outline-none hover:bg-gray-900 rounded text-white mt-4 md:mt-0" rel="noreferrer" target="_blank"><FaGithub className="w-5 h-5 mr-1" />Love code?</a>
          ...
          <div className="bg-black relative bg-opacity-60 text-white font-semibold text-xl flex flex-col my-5 mt-14 shadow-md py-2 rounded items-center">
            <p className="text-1xl title-font font-medium text-yellow-400 mb-4">Contact me</p>
