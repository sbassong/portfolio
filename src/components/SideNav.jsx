      ...
      <div className="px-8 md:px-10 lg:px-12">  
        ...
        <div class="text-white lg:max-w-lg w-full">
          <div className="text-lg md:text-xl font-bold flex flex-col mt-5 lg:mt-8 mb-2 lg:mb-5">
            <a href="#about" className="block my-2 lg:my-5 lg:inline-block lg:mt-0  hover:text-yellow-400">ABOUT</a>
            <a href="#projects" className="block my-2 lg:my-5 lg:inline-block lg:mt-0  hover:text-yellow-400">PROJECTS</a>
            <a href="#skills" className="block my-2 lg:my-5 lg:inline-block lg:mt-0 hover:text-yellow-400">SKILLS</a>
            <a href="https://drive.google.com/file/d/1vsehuFtOWocfYJI4TDIYDiI5lG-VR2o-/view?usp=sharing" className="block my-2 lg:my-5 lg:inline-block lg:mt-0 hover:text-yellow-400" rel="noreferrer" target="_blank">RESUME</a>
          </div>
          ...
          <div className="w-full bg-black relative bg-opacity-60 text-white font-semibold flex flex-col mb-3 lg:mb-4 mt-6 lg:mt-8 shadow-md py-2 rounded items-center">
            ...
            <p className="w-3/4 my-2 inline-flex items-center py-1 px-1 focus:outline-none rounded text-sm lg:text-base mt-4 md:mt-0"><FaPhoneSquareAlt className="w-5 h-5 mr-1" /> 206-402-7371</p>
            <p className="my-2 inline-flex items-center py-1 px-1 focus:outline-none rounded text-sm lg:text-base mt-4 md:mt-0"><MdOutlineAlternateEmail className="w-5 h-5 mr-1" /> sam.bassong@gmail.com</p>
          </div>
        </div>
