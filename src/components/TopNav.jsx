    ...
    <header className="overflow-x-hidden sticky w-full top-0 z-10 bg-needle-bg bg-no-repeat bg-cover bg-top">
      <div className="sticky w-full flex justify-between py-4 bg-indigo-900 bg-opacity-70">
        ...
        <section className='flex mr-5'>
          <a href="https://drive.google.com/file/d/1vsehuFtOWocfYJI4TDIYDiI5lG-VR2o-/view?usp=sharing" className="mx-1 inline-flex items-center bg-blue-500 border-0 py-1 px-2 hover:bg-blue-600 text-white focus:outline-none rounded text-base" rel="noreferrer" target="_blank"> Resume <ImProfile className="w-4 h-4 ml-2" /> </a>
