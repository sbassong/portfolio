    ...
    <section id="about">
      <div className="container h-screen mx-auto flex px-5 xl:px-10 py-5 lg:py-10 flex-row items-center">
        ...
        <div className="mx-auto w-full lg:w-4/5 flex flex-col md:items-start md:text-left p-4 md:p-8 lg:p-12 xl:p-16 items-center text-center bg-black bg-opacity-60 rounded-xl ">
          <h1 className="text-white title-font text-2xl lg:text-4xl mb-2 lg:mb-4 font-medium ">Hi, I'm Sam!</h1>
          <h1 className="text-yellow-400 title-font text-2xl lg:text-4xl mb2 lg:mb-4 font-medium ">I want to build accessible equity-minded technologies</h1>

          <p className="my-5 lg:my-10 text-white text-medium lg:text-xl font-medium ">
          ...
          <div className="md:flex md:flex-wrap md:justify-around w-full mt-2 md:mt-8">
            <a
              href="#skills"
